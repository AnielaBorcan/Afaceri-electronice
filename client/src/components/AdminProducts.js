...
export default function AdminProducts() {
    ...
    const getProducts = (
        ...
        fetch(
            `http://localhost:8080/products?${filterString}&sortField=${sortField || ""}&sortOrder=${sortOrder || ""
            ...
            .then((data) => {
                ...
                data.records.forEach((product) => {
                    ...
                    fetch(`http://localhost:8080/categoriesId/${product.categoryId}`, {
                        method: "GET",
                    })
                        .then((res) => res.json())
                        .then((data) => {
    ...
    const getCategory = (id) => {
        fetch(`http://localhost:8080/categoriesId/${id}`, {
            method: "GET",
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const getProduct = (id) => {
        fetch(`http://localhost:8080/productsCateg/${id}`, {
            method: "GET",
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const putProduct = (id) => {
        setError("");
        fetch(`http://localhost:8080/categories/${categoryRef.current.value}`, {
            method: "GET",
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const postProduct = () => {
        fetch(`http://localhost:8080/categories/${categoryRefAdd.current.value}`, {
            method: "GET",
        })
            .then((res) => res.json())
            .then((data) => {
